...
function __wasm_bindgen_func_elem_2600(arg0, arg1) {
    wasm.__wasm_bindgen_func_elem_2600(arg0, arg1);
}

function __wasm_bindgen_func_elem_3056(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_3056(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_4563(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_4563(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
const S3ClientFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_s3client_free(ptr >>> 0, 1));
...
export class S3Client {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        S3ClientFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_s3client_free(ptr, 0);
    }
    /**
     ...
     */
    constructor(access_key_id, secret_access_key, region, bucket, endpoint) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(access_key_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(secret_access_key, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(region, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len2 = WASM_VECTOR_LEN;
            const ptr3 = passStringToWasm0(bucket, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len3 = WASM_VECTOR_LEN;
            var ptr4 = isLikeNone(endpoint) ? 0 : passStringToWasm0(endpoint, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            var len4 = WASM_VECTOR_LEN;
            wasm.s3client_new(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
            ...
            this.__wbg_ptr = r0 >>> 0;
            S3ClientFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
    ...
    list(path) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.s3client_list(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
     * @param {string} path
    ...
    read(path) {
        const ptr0 = passStringToWasm0(path, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.s3client_read(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
     * @param {string} path
    ...
    stat(path) {
        const ptr0 = passStringToWasm0(path, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.s3client_stat(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
     * @param {string} path
    ...
    write(path, data) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.s3client_write(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return takeObject(ret);
    }
    /**
     * @param {string} path
    ...
    delete(path) {
        const ptr0 = passStringToWasm0(path, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.s3client_delete(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
}
if (Symbol.dispose) S3Client.prototype[Symbol.dispose] = S3Client.prototype.free;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_4d6668f66048c4fb = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_new_ff12d2b041fb48f1 = function(arg0, arg1) {
        try {
            ...
            var cb0 = (arg0, arg1) => {
                ...
                state0.a = 0;
                try {
                    return __wasm_bindgen_func_elem_4563(a, state0.b, arg0, arg1);
                } finally {
                    state0.a = a;
                }
            };
    ...
    imports.wbg.__wbindgen_cast_67a2b2aa6df497de = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 583, function: Function { arguments: [], shim_idx: 584, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_2591, __wasm_bindgen_func_elem_2600);
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__wbindgen_cast_c16fc8a610ef082f = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 656, function: Function { arguments: [Externref], shim_idx: 657, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_3040, __wasm_bindgen_func_elem_3056);
        return addHeapObject(ret);
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('opendal_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
