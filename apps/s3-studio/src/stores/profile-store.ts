  ...
  persist(
    (set, get) => ({
      ...
      clearConnectionTest: (profileId) => {
        set((state) => {
          const { [profileId]: _removed, ...rest } = state.connectionTest;
